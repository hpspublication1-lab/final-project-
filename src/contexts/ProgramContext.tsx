...
export const COURSES_MAP: Record<CanonicalCourseId, ProgramDetails> = {
  ...
  cee_medical: {
    id: 'cee_medical',
    legacySlug: 'cee',
    name: 'CEE — Medical Entrance Preparation',
    shortName: 'CEE Medical',
  ...
  ielts: {
    id: 'ielts',
    legacySlug: 'english',
    name: 'IELTS — English Language Mastery',
    shortName: 'IELTS & English',
  ...
  digital_marketing: {
    ...
    legacySlug: 'digital',
    name: 'Digital Marketing — Build Digital Skills',
  ...
  artificial_intelligence: {
    ...
    legacySlug: 'digital',
    name: 'Artificial Intelligence — AI Academy',
